...
- Sub protective high-pass: omitted in this variant
...
- Sub: low-pass LR4 at 140 Hz; no protective high-pass in crossover_sub.txt.
...
## No Sub High-Pass Variant

This folder is identical to `Output_140_harman_target` except `crossover_sub.txt` omits the 20 Hz high-pass. Use this only if your subwoofer/room are comfortable below 20 Hz and you are listening at sane levels first.
