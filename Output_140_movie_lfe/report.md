...
|---|---:|---:|---:|---:|
| Left | 1.500 | -2.775 | 1022 | 6 |
| Right | 1.500 | -3.686 | 1022 | 6 |
...
This variant keeps the 140 Hz crossover, delays, FIR files, and main-channel PEQ from the good music profile. Only the Sub PEQ is changed:

- The 57.86 Hz cut is relaxed from -5.63 dB to -2.81 dB.
- A +4.0 dB low shelf at 35 Hz is added for movie/LFE weight.
- If it is still polite, raise the Sub output gain another +2 to +4 dB for a movie preset.

Use this as a second preset/profile rather than replacing the music tuning outright.
