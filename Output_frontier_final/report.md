...
- Left frontier accepted: yes; solver status optimal_inaccurate; dense max FIR boost +3.00 dB at 16548.3 Hz; dense boost over cap +0.00 dB; safety refinements 0; inaccurate status certified by dense guardrail.
- Right FIR used: frontier cvxpy.
- Right frontier accepted: yes; solver status optimal_inaccurate; dense max FIR boost +3.00 dB at 12173.6 Hz; dense boost over cap +0.00 dB; safety refinements 0; inaccurate status certified by dense guardrail.
- Sub FIR used: flat guardrail fallback.
- Sub frontier accepted: no; solver status optimal_inaccurate; dense max FIR boost +0.60 dB at 76.9 Hz; dense boost over cap +0.08 dB; safety refinements 0; rejection reason: solver_status: optimal_inaccurate.
...
- Predicted Left+Sub RMS error, 50-160 Hz: 6.58 dB.
- Predicted Right+Sub RMS error, 50-160 Hz: 6.05 dB.
- Predicted L/R mismatch after correction, 80-10000 Hz: 6.52 dB.
- Worst crossover-region cancellation indicator: -3.14 dB at 153.81 Hz.
- Left: RMS target error 7.58 dB before correction, 7.80 dB after PEQ+FIR in its correction band.
- Right: RMS target error 7.73 dB before correction, 7.53 dB after PEQ+FIR in its correction band.
...
|---:|---:|---:|---:|---:|---:|---:|
| 50.17 | 81.65 | 81.64 | 87.81 | 87.45 | -0.01 | -0.02 |
| 60.06 | 87.87 | 87.88 | 91.77 | 93.14 | -0.06 | -0.05 |
| 69.95 | 82.10 | 81.90 | 84.67 | 85.09 | 0.09 | -0.10 |
| 79.83 | 85.25 | 85.07 | 92.97 | 84.91 | 0.13 | -0.06 |
| 90.09 | 79.61 | 79.63 | 84.29 | 73.81 | 0.14 | 0.15 |
| 99.98 | 82.84 | 83.02 | 85.54 | 83.32 | 0.06 | 0.25 |
| 109.86 | 77.45 | 77.57 | 65.27 | 74.58 | 0.16 | 0.29 |
| 120.12 | 84.38 | 85.20 | 80.19 | 89.65 | -0.38 | 0.44 |
| 139.89 | 81.36 | 80.10 | 86.94 | 87.19 | 0.67 | -0.59 |
