...
- Left frontier accepted: no; solver status optimal; dense max FIR boost +36.07 dB at 2479.6 Hz; dense boost over cap +33.07 dB; safety refinements 0; rejection reason: dense_guardrail_violation.
- Right FIR used: legacy fallback.
- Right frontier accepted: no; solver status frontier_disabled_after_left_rejected; dense max FIR boost +0.00 dB at 0.0 Hz; dense boost over cap +0.00 dB; safety refinements 0; rejection reason: solver_status: frontier_disabled_after_left_rejected.
- Sub FIR used: flat guardrail fallback.
- Sub frontier accepted: no; solver status frontier_disabled_after_left_rejected; dense max FIR boost +0.00 dB at 0.0 Hz; dense boost over cap +0.00 dB; safety refinements 0; rejection reason: solver_status: frontier_disabled_after_left_rejected.
